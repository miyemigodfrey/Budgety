...
import { SourceSummaryDto } from "./dto/source-summary.dto";
import {
	SourceResponseDto,
...
export class SourcesController {
	...
	@Get(":id/summary")
	@ApiOperation({ summary: "Get source inflow/outflow summary" })
	@ApiQuery({
		name: "period",
		required: false,
	...
	getSummary(
		...
		return this.sourcesService.getSourceSummary(id, user.id, period);
	}
